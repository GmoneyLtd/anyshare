...
<img src="./anyshare-screenshot.png" alt="anyShare Screenshot" width="400px" style="display: flex;">
...
- **高效下载**: 支持范围请求（Range requests），实现断点续传下载和分片下载, 分片下载需要基于页面按钮实现，如果通过浏览器直接访问文件，将无法触发分片下载转而采用基于流的完整下载。
